...
public class T162002 {
    ...
    private String yuSuanZaoJia;

    private String yuSuanChengBen;

    private String yingKuiEDu;

    private String liRunDianBiaoJi;
    ...
    public String getYuSuanZaoJia() {
        return yuSuanZaoJia;
    }

    public void setYuSuanZaoJia(String yuSuanZaoJia) {
        this.yuSuanZaoJia = yuSuanZaoJia == null ? null : yuSuanZaoJia.trim();
    }
    ...
    public String getYingKuiEDu() {
        return yingKuiEDu;
    }

    public void setYingKuiEDu(String yingKuiEDu) {
        this.yingKuiEDu = yingKuiEDu == null ? null : yingKuiEDu.trim();
    }

    public String getLiRunDianBiaoJi() {
        return liRunDianBiaoJi;
    }

    public void setLiRunDianBiaoJi(String liRunDianBiaoJi) {
        this.liRunDianBiaoJi = liRunDianBiaoJi == null ? null : liRunDianBiaoJi.trim();
    }
